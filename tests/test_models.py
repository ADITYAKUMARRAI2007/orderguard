...
def test_all_twenty_gates_exist():
    """docs/GATES.md promises 20 gates. Prove the code has 20."""
    assert len(PRE_PAYMENT_GATES) == 11
    assert len(POST_PAYMENT_GATES) == 9
    assert len(set(PRE_PAYMENT_GATES) | set(POST_PAYMENT_GATES)) == 20
